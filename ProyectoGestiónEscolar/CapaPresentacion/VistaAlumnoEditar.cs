...
namespace CapaPresentacion
{
    public partial class VistaAlumnoEditar : Form
    {
        ...
        {
            this.dataListado.DataSource = NAlumno.MostrarEditar();
        ...
        {
            Ingresar_Alumno form = Ingresar_Alumno.GetInstancia();
            Image par16;

            string par1, par2, par3, par4, par5, par6, par7, par8, par9, par10, par11, par12, par13, par14, par15, par17, par18, par19, par20, par21;
            par1 = Convert.ToString(this.dataListado.CurrentRow.Cells["Código"].Value);
            par2 = Convert.ToString(this.dataListado.CurrentRow.Cells["Código de Alumno"].Value);
            ...
            par13 = Convert.ToString(this.dataListado.CurrentRow.Cells["Municipio"].Value);
            par14 = Convert.ToString(this.dataListado.CurrentRow.Cells["Departamento"].Value);
            par15 = Convert.ToString(this.dataListado.CurrentRow.Cells["Teléfono"].Value);

            byte[] imagenBuffer = (byte[])this.dataListado.CurrentRow.Cells["Foto"].Value;
            System.IO.MemoryStream ms = new System.IO.MemoryStream(imagenBuffer);

            par16 = Image.FromStream(ms);
            ...
            par19 = Convert.ToString(this.dataListado.CurrentRow.Cells["DPI"].Value);
            ...
            form.SetAlumnoEditar(par1, par2, par3, par4, par5, par6, par7, par8, par9, par10, par11, par12, par13, par14, par15, par16, par17, par18, par19, par20, par21);
            this.Hide();
        }
    }
}
